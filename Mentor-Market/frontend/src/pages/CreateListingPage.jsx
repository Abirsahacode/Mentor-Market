...
export default function CreateListingPage({ type }) {
  ...
  const submit = async (event) => {
    ...
    try {
      const payload = { ...form };
      if (!isRequest) payload.has_trial = form.has_trial === "true";
