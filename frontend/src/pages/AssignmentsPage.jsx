...
export default function AssignmentsPage() {
  ...
  const create = async (event) => { event.preventDefault(); try { await api.post("/assignments", form); setMessage("Assignment created."); reload(); } catch (requestError) { setMessage(getErrorMessage(requestError)); } };
