...
const configs = {
  users: { title: "Manage users", endpoint: "/admin/users?limit=100", columns: [{ key: "full_name", label: "Name" }, { key: "email", label: "Email" }, { key: "role", label: "Role" }, { key: "is_active", label: "Active", render: status }, { key: "created_at", label: "Joined", render: (v) => new Date(v).toLocaleDateString() }] },
  students: { title: "Manage students", endpoint: "/admin/users?role=student&limit=100", columns: [{ key: "full_name", label: "Student" }, { key: "email", label: "Email" }, { key: "phone", label: "Phone" }, { key: "is_active", label: "Active", render: status }] },
  tutors: { title: "Manage tutors", endpoint: "/admin/users?role=tutor&limit=100", columns: [{ key: "full_name", label: "Tutor" }, { key: "email", label: "Email" }, { key: "phone", label: "Phone" }, { key: "is_active", label: "Active", render: status }] },
