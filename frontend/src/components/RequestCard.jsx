...
export default function RequestCard({ request, action, anonymizeStudent = false }) {
  ...
  return (
    <article className="request-card">
      ...
      <div className="request-bottom">
        <div className="request-author"><UserAvatar name={displayName} size="tiny" /><span><small>Posted by</small><strong>{displayName}</strong></span></div>
